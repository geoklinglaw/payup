...
import {
  Box, Card, CardBody, Heading, HStack, Input,
  NumberInput, NumberInputField, Select, SimpleGrid, Stack, Text,
  Table, Thead, Tbody, Tr, Th, Td, Checkbox, IconButton
      ...
      <Card>
        <CardBody>
          ...
          <HStack justify="space-between" mt={6}>
            <Text fontWeight="semibold">Estimated Total (incl. tax): ${total.toFixed(2)}</Text>
            {/* Save button removed – FAB arrow will save */}
          </HStack>
        </CardBody>
      </Card>
    </Box>
